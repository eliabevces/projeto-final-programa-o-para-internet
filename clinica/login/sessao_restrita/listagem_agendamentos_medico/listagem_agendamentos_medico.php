    ...
    <body>
        ...
        <header>
            ...
            <div class="nav_buttons">
                ...
                <a href="listagem_agendamentos_medico.php">Listar meus Agendamentos</a>
        ...
        <main>
            <div class="container">
                <h3>Não autorizado: Usuário logado não é médico</h3>
            </div>
        </main>
...
try {
  ...
  $sql = <<<SQL
  SELECT codigo, codigo_medico, data, horario, nome, sexo, email
  FROM Agenda
  WHERE codigo_medico = ?
  SQL;
            ...
            <table class="table table-striped table-hover">
                ...
                <?php
                    while ($row = $stmt->fetch()) {
                        ...
                        echo <<<HTML
                            <tr>
                            <td><a href="php/exclui-agendamento-medico.php?codigo=$codigoAgenda">
